...
console.log(`TFMDBOT ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+923404923915; // Replace this with the actual owner number
        const ownerName = 'Tahir Iqbal Official'; // Replace this with the owner's name
        const organization = 'TF CODERS'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+923404923915', '') + '+923404923915@s.whatsapp.net'], // Mention the owner
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_TFMDBOT..._*'  }, { quoted: mek } )
...
try{
let dec = `> TFMDBOT-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ TFMDBOT-MD REPO: ${bot.REPO_LINK} 
┃
